...
mpi: $(FILE)
	nvcc -I/usr/local/openmpi/include -L/usr/local/openmpi/lib -lmpi -arch sm_70 $(FILE) -o cuda
	time UCX_WARN_UNUSED_ENV_VARS=n mpirun -mca pml ucx -x UCX_TLS=cuda,sm,posix -np $(NUM_RANKS) ./cuda 0.000001 $(SIZE) 1000000
